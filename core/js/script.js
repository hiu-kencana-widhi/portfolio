document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        id: {
            ...
            doc_page_title: "Dokumentasi Kegiatan",
            doc_page_desc: "Kumpulan momen dan dokumentasi visual dari berbagai kegiatan operasional dan teknis.",
            doc_telkom_title: "Telkom Indonesia — Operational Support",
            doc_telkom_desc: "Dokumentasi instalasi jaringan fiber optik, aktivasi layanan, dan pemeliharaan infrastruktur digital di lapangan.",
            doc_cargo_title: "PT. Dian Mega Kurnia — Air Cargo Operations",
            doc_cargo_desc: "Dokumentasi operasional kargo udara di Bandara Juanda, mencakup administrasi dokumen, penataan gudang, dan pengelolaan arus barang.",
            doc_wifi_title: "Freelance — WiFi Network Installation",
            doc_wifi_desc: "Dokumentasi proyek freelance pemasangan jaringan WiFi, router, dan penanganan gangguan koneksi untuk pelanggan residensial.",
            doc_warehouse_title: "Warehouse Administration — PT. Bismillah Bisnis Barokah",
            doc_warehouse_desc: "Dokumentasi pengelolaan stok barang (FIFO), administrasi dokumen gudang, dan pemeliharaan tata letak inventaris.",
        ...
        en: {
            ...
            doc_page_title: "Activity Documentation",
            doc_page_desc: "A collection of moments and visual documentation from various operational and technical activities.",
            doc_telkom_title: "Telkom Indonesia — Operational Support",
            doc_telkom_desc: "Documentation of fiber optic network installation, service activation, and digital infrastructure maintenance in the field.",
            doc_cargo_title: "PT. Dian Mega Kurnia — Air Cargo Operations",
            doc_cargo_desc: "Documentation of air cargo operations at Juanda Airport, covering document administration, warehouse layout, and cargo flow management.",
            doc_wifi_title: "Freelance — WiFi Network Installation",
            doc_wifi_desc: "Documentation of freelance projects for WiFi network installation, router setup, and connection troubleshooting for residential customers.",
            doc_warehouse_title: "Warehouse Administration — PT. Bismillah Bisnis Barokah",
            doc_warehouse_desc: "Documentation of stock management (FIFO), warehouse document administration, and inventory layout maintenance.",

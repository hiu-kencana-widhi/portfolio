document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        id: {
            ...
            about_p1: "Saya adalah seorang Lulusan Teknik Logistik yang berdedikasi terhadap optimasi rantai pasok (Supply Chain Management), operasional gudang, dan analisis data strategis. Latar belakang akademik membekali saya dengan pola pikir rekayasa logistik yang terstruktur untuk mereduksi inefisiensi biaya dan waktu.",
            about_p2: "Pengalaman lintas disiplin — dari operasional kargo udara hingga instalasi infrastruktur jaringan IT — membentuk karakter yang adaptif. Kombinasi pemahaman logistik fisik dan kecerdasan teknologi memungkinkan saya berkontribusi maksimal di era transformasi industri digital.",
        ...
        en: {
            ...
            about_p1: "I am a Logistics Engineering graduate dedicated to Supply Chain Management optimization, warehouse operations, and strategic data analysis. My academic background has equipped me with a structured logistics engineering mindset to reduce cost and time inefficiencies.",
            about_p2: "Interdisciplinary experience — from air cargo operations to IT network infrastructure installation — has shaped an adaptive character. The combination of physical logistics understanding and technological intelligence allows me to contribute maximally in the digital industrial transformation era.",
